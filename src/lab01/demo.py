...
def main():
    ...
    product2 = Product('Ноутбук Lenovo', 80000, 5, 'Электроника', 10)
    ...
    print(f'Цена со скидкой: {product1.final_price():.2f}')
    print()
    ...
    print('Остаток до пополнения:', product3.stock)
    product3.add_stock(5)
    print('Остаток после пополнения:', product3.stock)
    print(product3)
    print()
